            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-8 md:p-10 shadow-xl">
                    ...
                    <form className="space-y-6" onSubmit={handleSignUp}>
                        ...
                        <button className="w-full bg-tertiary-container text-on-primary font-bold py-3.5 rounded-lg active:scale-[0.98] transition-all duration-200 mt-2 shadow-lg shadow-primary/10 hover:brightness-110 cursor-pointer" type="button" onClick={handleGoogleSignUp}> Create account with Google </button>
                    </form>
